defmodule ElixirNinetyNineBackendChallenge do
  use Application
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: ElixirNinetyNineBackendChallenge.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    ElixirNinetyNineBackendChallenge.Endpoint.config_change(changed, removed)
    :ok
  end
end
